    ...
    describe('#take', () => {
        ...
        describe('not connected get with', () => {
            ...
            describe('until', () => {
                ...
                isSettable &&
                    it('should become final after the first observation after `until` becomes true (once)', () => {
            ...
            describe(`connected, using`, () => {
                ...
                describe('once', () => {
                    ...
                    describe('inside transactions', () => {
                        ...
                        noRollbackSupport ||
                            it('should rollback a once observation when a transaction aborts', () => {
                                const f$ = startTest({ once: true });
                ...
                describe('stopOnError', () => {
                    isAtom &&
                        it('should never update after an error', () => {
                    ...
                    isAtom &&
                        it('should support a synchronous error without maintaining garbage', () => {
                            assertDerivableAtom(a$).setError('my error');
                            let connectionChanges = 0;
                            a$.connected$.react(() => connectionChanges++, { skipFirst: true });
                    ...
                    isAtom &&
                        it('should disconnect after the first error', () => {
                            let connectionChanges = 0;
                            a$.connected$.react(() => connectionChanges++, { skipFirst: true });
                ...
                describe('skipFirst', () => {
                    ...
                    describe('inside transactions', () => {
                        ...
                        noRollbackSupport ||
                            it("should rollback according to Schrödinger's observation rules", () => {
                                const f$ = startTest({ skipFirst: true });
                        ...
                        noRollbackSupport ||
                            it('should not leak skipped state when a transaction rolls back', () => {
                                const f$ = startTest({ skipFirst: true });
