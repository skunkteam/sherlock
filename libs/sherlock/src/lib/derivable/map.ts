...
export function mapMethod<B, V>(
    this: BaseDerivable<B>,
...
export function mapStateMethod<B, V>(
    this: BaseDerivable<B>,
    get: (state: State<B>) => MaybeFinalState<V>,
    set?: (v: V, b: State<B>) => B,
): Derivable<V> {
    return set && isSettable(this)
        ? new BiMapping(this, get, function (v) {
              return set.call(this, v as V, this._base.getState());
          })
