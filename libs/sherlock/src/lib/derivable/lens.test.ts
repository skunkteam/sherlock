            ...
            return lens(
                {
                    ...
                    set(newValue, prop1, prop2) {
                        obj1$.swap(
                            obj =>
                                FinalWrapper.map(newValue, unwrapped => ({ ...obj, [prop1]: unwrapped })) as typeof obj,
                        );
                        obj2$.swap(
                            obj =>
                                FinalWrapper.map(newValue, unwrapped => ({ ...obj, [prop2]: unwrapped })) as typeof obj,
                        );
                    },
                },
                'prop1',
