...
describe.skip('expert', () => {
    describe('`.autoCache()`', () => {
        ...
        it('multiple executions', () => {
             ...
             */
            expect(hasDerived).not.toHaveBeenCalledTimes(__YOUR_TURN__);
             ...
             */
            expect(hasDerived).toHaveBeenCalledTimes(__YOUR_TURN__); // how many times?
        });
        ...
        it('autoCaching', async () => {
            ...
            expect(firstHasDerived).toHaveBeenCalledTimes(__YOUR_TURN__); // How many times was it called?
            // second after last .get()
            expect(secondHasDerived).toHaveBeenCalledTimes(__YOUR_TURN__); // How many times was it called?
        });
    });
    ...
    describe('`derivableCache`', () => {
        ...
        function reactor(v: any) {
            // TODO: add stopper function in type definition?
            reactSpy(v);
        }
         ...
         */
        it('multiple setups', () => {
            // To not make things difficult with `unresolved`
            // for this example, imagine we get a response synchronously
        ...
        describe('setup inside a derivation', () => {
            ...
            it('unresolveable values', () => {
                ...
                expect(reactSpy).toHaveBeenCalledWith(__YOUR_TURN__, expect.toBeFunction());
            ...
            it('uncached Derivables', () => {
                ...
                expect(reactSpy).toHaveBeenCalledExactlyOnceWith([undefined]); // But it should emit `undefined` // TODO: Might also need the expect.toBeFunction() generic.
                 ...
                 */
                expect(reactSpy).toHaveBeenCalledTimes(__YOUR_TURN__);
                expect(reactSpy).toHaveBeenCalledWith([__YOUR_TURN__, __YOUR_TURN__], expect.toBeFunction());
            });
        });
        /**
        ...
        describe('a solution', () => {
            ...
            it('should fix everything :-)', () => {
                ...
                function lastEmittedHTMLs() {
                    // TODO: lastCall may be undefined, but it might be fine here.
