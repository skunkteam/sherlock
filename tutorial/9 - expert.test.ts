...
import { derivableCache } from '../libs/sherlock-utils/src';
import { DerivableAtom, atom, derive } from '../libs/sherlock/src';
    ...
    describe('`derivableCache`', () => {
        ...
        describe('setup inside a derivation', () => {
            ...
            it('uncached Derivables', () => {
                ...
                expect(reactSpy)
                    .to.have.been.calledOnce // But it should emit `undefined`
        ...
        describe('a solution', () => {
            ...
            it('should fix everything :-)', () => {
                ...
                function lastEmittedHTMLs() {
                    return reactSpy.lastCall.args[0];
                }
