...
describe.skip('reacting', () => {
     ...
     */
    describe.skip('stopping a reaction', () => {
        /**
    ...
    describe.skip('reactor options', () => {
         ...
         * `Derivable`/`function` as describe.skipd here.*
         *
    ...
    describe.skip('order of execution', () => {
        /**
