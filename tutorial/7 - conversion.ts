...
import { pairwise, scan, struct } from '../libs/sherlock-utils/src';
...
describe('conversion', () => {
    ...
    describe.skip('utils', () => {
        ...
        it('pairwise', () => {
            ...
            expect(reactSpy).to.have.been.calledTwice.and.calledWith(2);

            myCounter$.set(45);

            expect(reactSpy).to.have.been.calledThrice.and.calledWith(42);
        });
        ...
        it('scan', () => {
            ...
            expect(reactSpy).to.have.been.calledTwice.and.calledWith(4);

            myCounter$.set(45);

            expect(reactSpy).to.have.been.calledThrice.and.calledWith(49);
