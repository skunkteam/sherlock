...
describe('unresolved', () => {
     ...
     * become `unresolved` again after it has been set.
     */
    ...
    it('will propagate', () => {
         ...
         */
        const myDerivable$: Derivable<string> = myString$.and(myOtherString$).derive(_ => 'Both resolved');
        ...
        expect(myDerivable$.get()).toEqual('Both resolved');
